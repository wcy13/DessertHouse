	...
	<div class="main">
		...
		<div class="nav-main">
			<a href="/DessertHouse/bread" class="nav-main-item "
				...
				id="js-nav-3">甜点<span class="float-right color-white">|</span></a> <a
				href="/DessertHouse/drinks" class="nav-main-item active"
				id="js-nav-4">饮品<span class="float-right color-lanlv">|</span></a> <a
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#js-nav-3").mouseover(function() {
				...
				$("#js-nav-3").children("span").css("color","white");
